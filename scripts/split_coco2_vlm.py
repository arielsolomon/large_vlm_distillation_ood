...
for dir in dir_list:
    for annot in annotations:
        ...
        dir_exists(dst+dir+'/'+str(cat_num)+'_'+coco_classes[cat_num])
        copy(img_path+dir+'/'+img_file, dst+dir+'/'+str(cat_num)+'_'+coco_classes[cat_num]+'/'+coco_classes[cat_num]+'_'+img_file)
