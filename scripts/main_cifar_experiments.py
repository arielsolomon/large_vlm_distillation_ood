...
def main():
    ...
    if args.use_clip:
        ...
        if args.clip_repo == 'clip':
            import clip
            clip_model, _ = clip.load(args.clip_model, device=clip_device)
            ...
            #         transforms.Resize(size=32, interpolation=transforms.InterpolationMode.BICUBIC, max_size=None, antialias=None),
