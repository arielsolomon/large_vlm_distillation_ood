...
def get_model(num_classes, resnet18_weights_path):
    # Load your own ResNet-18 model
    # backbone = torchvision.models.resnet18()
    # backbone.load_state_dict(torch.load(resnet18_weights_path))
    backbone = torch.load(resnet18_weights_path)
    del backbone['state_dict']['fc.weight']
    del backbone['state_dict']['fc.bias']
...
if __name__ == "__main__":
    ...
    resnet18_weights_path = "/home/user1/ariel/fed_learn/large_vlm_distillation_ood/Rcnn/coco_8cls_resnet_distilled.pth"
    ...
    # Load model
    model = get_model(8, resnet18_weights_path)
    model.to(device)
