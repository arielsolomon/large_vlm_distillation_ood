...
# Datasets
parser.add_argument('-d', '--data', default='/work/large_vlm_distillation_ood/dataset/s_cars_ood_ind/', type=str)
parser.add_argument('-j', '--workers', default=4, type=int, metavar='N',
                    help='number of data loading workers (default: 4)')
# Optimization options
parser.add_argument('--epochs', default=90, type=int, metavar='N',
                    help='number of total epochs to run')
parser.add_argument('--repeat-epochs', default=5, type=int, metavar='N',
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='with_non_fine_tuned_17_07_all_losses_fine_tuned_clip', type=str, metavar='PATH',
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet50',
                    ...
                    help='model architecture: ' +
                        ...
                        ' (default: resnet18)')
# Openset-specific
parser.add_argument('--fine-tune-clip', default='/work/large_vlm_distillation_ood/finetune_clip/clip-vit-large-patch14-finetuned-stanford-cars_state_dict_openAI_format_17_07.pt')
...
parser.add_argument('--chatgpt-raw-text-file', type=str, default='/work/large_vlm_distillation_ood/dataset/s_cars_ood_ind/chatgpt.txt', help="file containing label descriptions generated by chatgpt")
...
parser.add_argument('--label-path', type=str, default='/work/large_vlm_distillation_ood/dataset/s_cars_ood_ind/label2text.txt', help='Path to label2text.txt')
