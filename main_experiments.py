...
# Datasets
parser.add_argument('-d', '--data', default='/home/user1/ariel/fed_learn/large_vlm_distillation_ood/datasets/s_cars_ood_ind_fixed/', type=str)
...
# Checkpoints
parser.add_argument('-c', '--checkpoint', default='with_non_fine_tuned_16_07', type=str, metavar='PATH',
...
parser.add_argument('--arch', '-a', metavar='ARCH', default='resnet50',
                    ...
                    help='model architecture: ' +
                        ...
                        ' (default: resnet18)')
# Openset-specific
parser.add_argument('--fine-tune-clip', default='/home/user1/ariel/fed_learn/large_vlm_distillation_ood/fine_tune_clip/clip-vit-large-patch14-finetuned-stanford-cars.pt')
parser.add_argument('--use-clip', default=True,action='store_true', help='whether to use CLIP model')
parser.add_argument('--clip-repo', type=str, default='clip', choices=['clip', 'open_clip', 'custom'])
...
parser.add_argument('--clip-align-image-classification', type=int, default=0, help="whether to use L-cls (vision-language alignment loss for classification) (0/1)")
...
parser.add_argument('--label-path', type=str, default='/home/user1/ariel/fed_learn/large_vlm_distillation_ood/datasets/s_cars_ood_ind_fixed/label2text.txt', help='Path to label2text.txt')
...
def main():
    ...
    if args.use_clip:
        ...
        if args.clip_repo == 'clip':
            ...
            clip_model = torch.load(args.fine_tune_clip)
            clip_preprocess = transforms.Compose([
                transforms.Resize(size=224, interpolation=transforms.InterpolationMode.BICUBIC, max_size=None,
                                  antialias=None),
                transforms.CenterCrop(size=(224, 224)),
                transforms.Normalize(mean=(0.48145466, 0.4578275, 0.40821073), std=(0.26862954, 0.26130258, 0.27577711))
            ])
