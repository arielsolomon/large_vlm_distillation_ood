...
src_txt = '/home/user1/ariel/fed_learn/large_vlm_distillation_ood/coco_2017_full_reduced_humans_resnet50/log.txt'
df_txt = pd.read_csv(src_txt, delimiter='	')
val_loss = df_txt['Valid Loss']
df_txt['Valid Loss'][20:].idxmin()
print(f"Min Loss value index is {df_txt['Valid Loss'][20:].idxmin()}")