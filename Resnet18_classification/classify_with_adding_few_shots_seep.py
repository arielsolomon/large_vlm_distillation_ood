...
sweep_id = wandb.sweep(sweep_config, project="classify_r50_dist_against_non_finetuned_CLIP_sweep_04_08")
...
def train_model(config=None):
    ...
    with wandb.init(config=config):
        ...
        for epoch in range(n_epochs):
            ...
            outdir = output_dir + 'fewshots_non_finetuned_CLIP_10samples_step'+'/'
            torch.save(model, "{}model_{}.pt".format(outdir + 'fewshots_non_finetuned_CLIP', epoch))
