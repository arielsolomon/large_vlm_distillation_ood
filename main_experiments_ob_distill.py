...
parser.add_argument('--chatgpt-raw-text-file', type=str, default='coco-2017/chatgpt.txt', help="file containing label descriptions generated by chatgpt")
...
parser.add_argument('--clip-filter-out-wrong-alignment', default=True, action='store_true', help="If L-vlalign is used, whether to filter out images whose teacher visual features are misaligned with their language labels")
...
def main():
    ...
    print('\nVal on train directory: ', val_on_train_dir)
