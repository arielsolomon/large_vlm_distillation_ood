...
def parse_opt():
    ...
    parser.add_argument("--data", type=str, default=ROOT / "data/coco_full.yaml", help="dataset.yaml path")
    ...
    parser.add_argument("--name", default="distilized_yv5n_model_against_yv5l", help="save to project/name")
